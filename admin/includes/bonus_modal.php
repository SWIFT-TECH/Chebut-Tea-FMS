        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="kgs" name="kgs">
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="mins" class="col-sm-3 control-label">Grams</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="kgs_edit" class="col-sm-3 control-label">KGS</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="kgs_edit" name="kgs">
                    </div>
                </div>
                <div class="form-group">
                    <label for="mins_edit" class="col-sm-3 control-label">Grams</label>
