          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, cashadvance.id AS caid, farmers.employee_id AS empid FROM cashadvance LEFT JOIN farmers ON farmers.id=cashadvance.employee_id ORDER BY date_advance DESC";
