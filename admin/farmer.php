...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, farmers.id AS empid FROM farmers LEFT JOIN rates ON rates.id=farmers.position_id LEFT JOIN collection_centre ON collection_centre.id=farmers.schedule_id";
  ...
  <?php include 'includes/farmer_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#centre').val(response.centre).html(response.centre);
    }
  });
}
</script>
